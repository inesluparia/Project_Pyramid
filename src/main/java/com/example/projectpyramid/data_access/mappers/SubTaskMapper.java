...
public class SubTaskMapper implements Mapper<SubTask> {
     ...
     */
    public int insert(@NotNull SubTask subTask) throws SQLIntegrityConstraintViolationException, DBManager.DatabaseConnectionException {
     ...
     */
    public void update(@NotNull SubTask subTask) throws DBManager.DatabaseConnectionException {
     ...
     */
    public void delete(@NotNull SubTask subTask) throws DBManager.DatabaseConnectionException {
     ...
     */
    public SubTask findById(int subTaskId) throws DBManager.DatabaseConnectionException {
     ...
     */
    public List<SubTask> findAllByTaskId(int taskId) throws DBManager.DatabaseConnectionException {
     ...
     */
    public ArrayList<SubTask> getSubTasks(int taskId ) throws DBManager.DatabaseConnectionException {
        String query = "SELECT id, name, description, duration FROM subtasks WHERE task_id = ?";
        Connection connection = DBManager.getConnection();
        ArrayList<SubTask> subTasks = new ArrayList<>();
     ...
     */
    public void update(String name, String description, int durationInManHours, int id) throws Exception {
